...
const Design = () => {
    const caseStudies = [
        {
            title: "Planting",
            mockup: "planting_empathy_map.jpg",
            slides: "https://docs.google.com/presentation/d/1dOjgu_sHbX1tURTPiMInShJgPFo20LncTjsSOoawQow/edit?usp=sharing",
                ...
                <div className="portfolio-container">
                    {caseStudies.map ((project) => (
                        <div className="project-container" key={project.title}>
                            <img className="project-example" id={project.id} src={require(`../../assets/mockups/${project.mockup}`)} alt={project.title}
                            ></img>                                
